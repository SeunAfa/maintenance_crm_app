...
function buildCompletedThisWeek() {
  ...
  return seeds.map((s, i) => {
    ...
    return {
      id,
      caseId,
      seedPerf:    true, // demo filler for the dashboard graphs — dates re-anchored to the current week on every load
      title:       s.title,
      description: s.title,
